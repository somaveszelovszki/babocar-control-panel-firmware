...
class LapTrackSectionProvider : public ILapTrackSectionProvider {
  public:
    LapTrackSectionProvider(const bool enableLineOffset, const bool enableLineAngle)
        : enableLineOffset_{enableLineOffset}, enableLineAngle_{enableLineAngle} {}
    ...
    LapTrackSections operator()(const size_t) override {
        ...
        return LapTrackSections{
            {true, meter_t{5}, TrackSection::TransitionCriteria::pattern(LinePattern::BRAKE),
             TrackSection::ControlParameters{
                 m_per_sec_t(3),
                 millisecond_t(500),
                 {OrientedLine{centimeter_t(0), degree_t(0)}, OrientedLine{offset, angle}}}},
            {false, meter_t{1}, TrackSection::TransitionCriteria::distance(),
             TrackSection::ControlParameters{
                 m_per_sec_t(1),
                 millisecond_t(500),
                 {OrientedLine{offset, angle}, OrientedLine{-offset, -angle}}}},
            {false, meter_t{2}, TrackSection::TransitionCriteria::acceleration(),
             TrackSection::ControlParameters{
                 m_per_sec_t(2),
                 millisecond_t(500),
                 {OrientedLine{-offset, -angle}, OrientedLine{centimeter_t(0), degree_t(0)}}}}};
    }
...
class RaceTrackControllerTestBase : public Test {
  ...
  protected:
    ...
    void checkUpdate(const size_t lap, const size_t sectionIdx,
                     const ControlData& expectedControl) {
...
TEST_F(RaceTrackControllerOffsetTest, interpolateUntilPattern) {
    ...
    checkUpdate(
        ...
        {m_per_sec_t(3),
         millisecond_t(500),
         false,
         {OrientedLine{centimeter_t(0), degree_t(0)}, OrientedLine{LINE_OFFSET / 2, degree_t(0)}}});
    ...
    checkUpdate(1, 0,
                {m_per_sec_t(3),
                 millisecond_t(500),
                 false,
                 {OrientedLine{LINE_OFFSET, degree_t(0)}, OrientedLine{LINE_OFFSET, degree_t(0)}}});
...
TEST_F(RaceTrackControllerOffsetTest, interpolateUntilDistance) {
    ...
    checkUpdate(
        ...
        {m_per_sec_t(1),
         millisecond_t(500),
         true,
         {OrientedLine{centimeter_t(1), degree_t(0)}, OrientedLine{centimeter_t(0), degree_t(0)}}});
...
TEST_F(RaceTrackControllerAngleTest, interpolateUntilPattern) {
    ...
    checkUpdate(
        ...
        {m_per_sec_t(3),
         millisecond_t(500),
         false,
         {OrientedLine{centimeter_t(0), LINE_ANGLE}, OrientedLine{centimeter_t(0), LINE_ANGLE}}});
...
TEST_F(RaceTrackControllerAngleTest, interpolateUntilDistance) {
    ...
    checkUpdate(
        ...
        {m_per_sec_t(1),
         millisecond_t(500),
         true,
         {OrientedLine{centimeter_t(0), degree_t(1)}, OrientedLine{centimeter_t(0), degree_t(0)}}});
