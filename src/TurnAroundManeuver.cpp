...
TurnAroundManeuver::TurnAroundManeuver(const CarProps& car, const m_per_sec_t speed, const meter_t sineArcLength, const meter_t circleRadius)
    : Maneuver()
    , speed_(-sgn(car.speed) * speed)
    , sineArcLength_(sineArcLength)
