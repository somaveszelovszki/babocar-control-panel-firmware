...
PanelLink<DistSensorPanelOutData, DistSensorPanelInData>
    frontDistSensorPanelLink(panelLinkRole_t::Master, {uart_FrontDistSensor});

#if REAR_DISTANCE_SENSOR_ENABLED
PanelLink<DistSensorPanelOutData, DistSensorPanelInData>
    rearDistSensorPanelLink(panelLinkRole_t::Master, {uart_RearDistSensor});
...
bool handleDistanceSensor(PanelLink<DistSensorPanelOutData, DistSensorPanelInData>& panelLink,
