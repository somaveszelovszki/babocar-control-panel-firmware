...
size_t formatBody(char* const output, const size_t size, const DebugMessage::CarData& car) {
    return micro::format_to_n(
        output, size, "[{},{},{:.2f},{:.2f},{:.2f},{:.2f},{},{:.2f},{},{:.2f},{}]",
        ...
        car.props.pose.angle.get(), car.props.speed.get(), car.props.frontWheelAngle.get(),
        ...
        car.control.lineControl.target.angle.get(), car.props.isRemoteControlled ? 1 : 0);
}
...
size_t formatBody(char* const output, const size_t size,
    ...
    return micro::format_to_n(
        output, size, "[{},{:.2f},{},{},{},{},{}]", index, control.speed.get(),
...
size_t formatBody(char* const output, const size_t size,
                  const DebugMessage::RadioCommand& command) {
...
template <typename T> bool parseOutput(char* const input, const Type type, T& output) {
...
size_t DebugMessage::format(char* const output, const size_t size,
...
bool DebugMessage::parse(char* const input,
