...
void buildRaceLabyrinthGraph(LabyrinthGraph& OUT graph) {
    ...
    graph.connect('A', {3 * PI_2, Direction::LEFT}, 'B', {PI_2, Direction::RIGHT},
                  centimeter_t(241));
    graph.connect('A', {3 * PI_2, Direction::RIGHT}, 'D', {radian_t(0), Direction::LEFT},
                  centimeter_t(198));
    graph.connect('A', {PI_2, Direction::CENTER}, 'F', {PI_2, Direction::RIGHT}, centimeter_t(397));
    graph.connect('B', {PI_2, Direction::LEFT}, 'D', {radian_t(0), Direction::RIGHT},
                  centimeter_t(198));
    graph.connect('B', {3 * PI_2, Direction::CENTER}, 'E', {radian_t(0), Direction::CENTER},
                  centimeter_t(198));
    graph.connect('D', {PI, Direction::LEFT}, 'G', {PI_2, Direction::RIGHT}, centimeter_t(198));
    graph.connect('D', {PI, Direction::CENTER}, 'I', {radian_t(0), Direction::CENTER},
                  centimeter_t(241));
    graph.connect('D', {PI, Direction::RIGHT}, 'F', {3 * PI_2, Direction::LEFT}, centimeter_t(197));
    graph.connect('E', {PI, Direction::LEFT}, 'J', {radian_t(0), Direction::RIGHT},
                  centimeter_t(241));
    graph.connect('E', {PI, Direction::RIGHT}, 'G', {3 * PI_2, Direction::LEFT}, centimeter_t(197));
    graph.connect('F', {PI_2, Direction::LEFT}, 'H', {radian_t(0), Direction::CENTER},
                  centimeter_t(200));
    graph.connect('F', {3 * PI_2, Direction::CENTER}, 'G', {PI_2, Direction::CENTER},
                  centimeter_t(241));
    graph.connect('F', {3 * PI_2, Direction::RIGHT}, 'I', {radian_t(0), Direction::LEFT},
                  centimeter_t(198));
    graph.connect('G', {PI_2, Direction::LEFT}, 'I', {radian_t(0), Direction::RIGHT},
                  centimeter_t(199));
    graph.connect('G', {3 * PI_2, Direction::RIGHT}, 'J', {radian_t(0), Direction::LEFT},
                  centimeter_t(198));
    graph.connect('H', {PI, Direction::LEFT}, 'K', {PI_2, Direction::RIGHT}, centimeter_t(198));
    graph.connect('H', {PI, Direction::RIGHT}, 'M', {radian_t(0), Direction::LEFT},
                  centimeter_t(241));
    graph.connect('I', {PI, Direction::LEFT}, 'L', {PI_2, Direction::RIGHT}, centimeter_t(198));
    graph.connect('I', {PI, Direction::CENTER}, 'N', {radian_t(0), Direction::CENTER},
                  centimeter_t(241));
    graph.connect('I', {PI, Direction::RIGHT}, 'K', {3 * PI_2, Direction::LEFT}, centimeter_t(197));
    graph.connect('J', {PI, Direction::CENTER}, 'L', {3 * PI_2, Direction::LEFT},
                  centimeter_t(197));
    graph.connect('K', {3 * PI_2, Direction::CENTER}, 'L', {PI_2, Direction::CENTER},
                  centimeter_t(241));
    graph.connect('K', {3 * PI_2, Direction::RIGHT}, 'N', {radian_t(0), Direction::LEFT},
                  centimeter_t(198));
    graph.connect('K', {PI_2, Direction::LEFT}, 'M', {radian_t(0), Direction::RIGHT},
                  centimeter_t(200));
    graph.connect('L', {PI_2, Direction::LEFT}, 'N', {radian_t(0), Direction::RIGHT},
                  centimeter_t(199));
    graph.connect('L', {3 * PI_2, Direction::RIGHT}, 'O', {radian_t(0), Direction::CENTER},
                  centimeter_t(198));
    graph.connect('M', {PI, Direction::LEFT}, 'R', {PI_2, Direction::RIGHT}, centimeter_t(198));
    graph.connect('M', {PI, Direction::CENTER}, 'Q', {radian_t(0), Direction::CENTER},
                  centimeter_t(120));
    ...
    graph.connect('N', {PI, Direction::CENTER}, 'S', {radian_t(0), Direction::CENTER},
                  centimeter_t(120));
    ...
    graph.connect('O', {PI, Direction::CENTER}, 'W', {3 * PI_2, Direction::CENTER},
                  centimeter_t(318));
    graph.connect('O', {PI, Direction::RIGHT}, 'T', {3 * PI_2, Direction::LEFT}, centimeter_t(197));
    graph.connect('P', {3 * PI_2, Direction::RIGHT}, 'R', {PI_2, Direction::LEFT},
                  centimeter_t(241));
    graph.connect('Q', {PI, Direction::LEFT}, 'V', {PI_2, Direction::CENTER}, centimeter_t(199));
    graph.connect('R', {3 * PI_2, Direction::RIGHT}, 'T', {PI_2, Direction::LEFT},
                  centimeter_t(241));
    ...
    graph.connect('T', {3 * PI_2, Direction::RIGHT}, 'U', {PI_2, Direction::LEFT},
                  centimeter_t(241));
    graph.connect('U', {3 * PI_2, Direction::CENTER}, 'X', {PI_2, Direction::CENTER},
                  centimeter_t(60));
    graph.connect('V', {3 * PI_2, Direction::RIGHT}, 'W', {PI_2, Direction::LEFT},
                  centimeter_t(241));
}
