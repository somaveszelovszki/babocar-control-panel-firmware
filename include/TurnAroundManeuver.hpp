...
public:
    TurnAroundManeuver();
    TurnAroundManeuver(const micro::CarProps& car, const micro::m_per_sec_t speed, const micro::meter_t sineArcLength, const micro::meter_t circleRadius);
    TurnAroundManeuver(const TurnAroundManeuver&) = default;
